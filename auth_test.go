...
func TestAuthRequest_GetAccessToken(t *testing.T) {
	...
	a.NotNil(authResponse.AccessToken, "Access token should not be nil")
	a.Equal(authResponse.AccessToken, "my_token", "Access token should be equal to the mocked response")
